...
/* package maze-0.1.0.0 */
#define VERSION_maze "0.1.0.0"
#define MIN_VERSION_maze(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "maze-0.1.0.0"

#define CURRENT_PACKAGE_KEY "maze-0.1.0.0"
